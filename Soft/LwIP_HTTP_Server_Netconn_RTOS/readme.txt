/**
  ...
  * @author  MCD Application Team, updated by C. Schoffit
  * @version V1.2.1
  * @date    12-June-2015
...
This demo uses a breakout board based on ENC28J60 chip to add Ethernet connectivity
to the STM32F429I-Discovery board. This require a SPI port available. The connection
layout is the following:

STM32F429I-Discovery    ENC28J60 module
    3V               -      VCC
    GND              -      GND
    PB4              ->     CS
    PC12             ->     SI
...
@par Directory contents
  ...
  - LwIP/LwIP_TCP_Echo_Server/Drivers/BSP/Components/enc28j60/enc28j60.c    Ethernet driver
  - LwIP/LwIP_TCP_Echo_Server/Drivers/BSP/Components/enc28j60/enc28j60.h    header for enc28j60.c
  - LwIP/LwIP_TCP_Echo_Server/Drivers/BSP/Components/enc28j60/lc.h          Protothreads general local continuity header
  - LwIP/LwIP_TCP_Echo_Server/Drivers/BSP/Components/enc28j60/lc-switch.h   Protothreads switch implementation for local continuity header
  - LwIP/LwIP_TCP_Echo_Server/Drivers/BSP/Components/enc28j60/pt.h          Protothreads macros
