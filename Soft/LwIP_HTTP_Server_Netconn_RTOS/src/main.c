...
/**
  * @brief  Initializes the STM324F429I-DISCOVERY's LCD and LEDs resources.
  * @param  None
  * @retval None
  */
static void BSP_Config(void)
{
  ...
  LCD_LOG_SetHeader((uint8_t *)"Webserver Netconn API");
  LCD_LOG_SetFooter((uint8_t *)"STM32F429I-Discovery board");
